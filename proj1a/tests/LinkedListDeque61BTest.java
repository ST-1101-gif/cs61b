...
public class LinkedListDeque61BTest {
    ...
    @Test
    /** This test verifies the isEmpty and size works well */
    ...
    @Test
    /** This test checks the removeFirst and removeLast */
    public void removeTest() {
        ...
        int item2 = lld.removeFirst();
        int item3 = lld.removeLast();
        assertThat(item1).isEqualTo(1);
        assertThat(item2).isEqualTo(2);
        assertThat(item3).isEqualTo(3);
    }

    @Test
    /** This test checks the get and getRecursive*/
